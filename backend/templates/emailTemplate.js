...
const getEmailTemplate = (name, company) => {
  ...
  <div style="font-family: Arial, sans-serif; font-size:15px; color:#333; line-height:1.6;">
    ...
    <p>
      I am a final-year <strong>Information Technology</strong> student with hands-on experience
      in full-stack development using <strong>React.js, Node.js, Express.js, and MongoDB</strong>,
      building scalable web applications.
    </p>

    <p>
      I recently worked on projects like a <strong>real-time collaborative code editor</strong>
      and an <strong>IoT-based server monitoring system</strong> during my internship with
      <strong>e-Yantra IIT Bombay</strong>.
    </p>

    <p>
      I am reaching out to explore any <strong>Full Stack Developer, Software Engineer,
      or Internship opportunities</strong> at <strong>${company}</strong>.
      I would greatly appreciate the opportunity to interview or discuss any suitable roles.
    </p>
    ...
    <p>
      <strong>Email:</strong> harshalkotkar04@gmail.com<br/>
      <strong>Mobile:</strong> +91 7249394597
    </p>
